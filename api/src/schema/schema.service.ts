...
const REAL_SQL_TABLES: Record<string, Array<{ name: string; description: string; attributes: Attribute[] }>> = {
  ...
  REM: [
    ...
    {
      name: 'MovFic2',
      description: 'Haberes y Descuentos informados por período — tabla transaccional principal de liquidaciones de sueldo. Clave por Año+Mes+Concepto+RUT. JOIN con CONCEPTO por CptTip+CptCod para saber si es haber o descuento. JOIN con PERSONAL por PerTip+PerCod+PerSec para datos del empleado.',
      attributes: [
        { id: 'r_mmeano',    name: 'MmeAno',    title: 'Año del período de liquidación (PK)',                                    type: 'n',      length:  5, dec: 0, prefix: 'REM' },
        { id: 'r_mmemes',    name: 'MmeMes',    title: 'Mes del período de liquidación 1-12 (PK)',                               type: 'n',      length:  5, dec: 0, prefix: 'REM' },
        { id: 'r_cpttip',    name: 'CptTip',    title: 'Tipo del concepto — clave del concepto (PK)',                           type: 'string', length:  1, dec: 0, prefix: 'REM' },
        { id: 'r_cptcod',    name: 'CptCod',    title: 'Código del concepto — clave del concepto (PK)',                         type: 'string', length:  3, dec: 0, prefix: 'REM' },
        { id: 'r_pertip2',   name: 'PerTip',    title: 'Tipo persona: 1=Persona (PK)',                                          type: 'n',      length:  5, dec: 0, prefix: 'REM' },
        { id: 'r_percod2',   name: 'PerCod',    title: 'Parte numérica del RUT del empleado (PK)',                              type: 'n',      length: 12, dec: 0, prefix: 'REM' },
        { id: 'r_persec2',   name: 'PerSec',    title: 'Secuencia de contrato del empleado (PK)',                               type: 'n',      length:  5, dec: 0, prefix: 'REM' },
        { id: 'r_mmecencod', name: 'MmeCenCod', title: 'Centro de costo si el concepto lo requiere (PK)',                       type: 'n',      length: 10, dec: 0, prefix: 'REM' },
        { id: 'r_mmearecod', name: 'MmeAreCod', title: 'Área de negocios si el concepto lo requiere (PK)',                      type: 'n',      length:  5, dec: 0, prefix: 'REM' },
        { id: 'r_mmesem',    name: 'MmeSem',    title: 'Número de semana si el concepto lo requiere (PK)',                      type: 'n',      length:  5, dec: 0, prefix: 'REM' },
        { id: 'r_mmedia',    name: 'MmeDia',    title: 'Día si el concepto lo requiere (PK)',                                   type: 'n',      length:  5, dec: 0, prefix: 'REM' },
        { id: 'r_mmeorigen', name: 'MmeOrigen', title: 'Origen: 0=Movimiento normal, 1=Movimiento Agrícola',                    type: 'n',      length:  5, dec: 0, prefix: 'REM' },
        { id: 'r_mmecaninf', name: 'MmeCanInf', title: 'Cantidad informada (horas, días, unidades según el concepto)',          type: 'n',      length: 11, dec: 5, prefix: 'REM' },
        { id: 'r_mmevalinf', name: 'MmeValInf', title: 'Valor informado en pesos CLP — monto del haber o descuento',           type: 'n',      length: 19, dec: 4, prefix: 'REM' },
        { id: 'r_mmecuoinf', name: 'MmeCuoInf', title: 'Número de cuota (para descuentos en cuotas)',                          type: 'n',      length: 10, dec: 0, prefix: 'REM' },
        { id: 'r_mmecuoref', name: 'MmeCuoRef', title: 'Glosa número de cuota de crédito',                                     type: 'string', length:  7, dec: 0, prefix: 'REM' },
      ],
    },
    {
      name: 'MOPPER2',
      description: 'Movimientos de personal por período — registra licencias médicas, vacaciones, permisos, ausentismo. Clave por Año+Mes+RUT+TipoMovimiento. JOIN con PERSONAL por PerTip+PerCod+PerSec.',
      attributes: [
        { id: 'r_mpeano',    name: 'MpeAno',    title: 'Año del período (PK)',                                                  type: 'n',      length:  5, dec: 0, prefix: 'REM' },
        { id: 'r_mpemes',    name: 'MpeMes',    title: 'Mes del período 1-12 (PK)',                                             type: 'n',      length:  5, dec: 0, prefix: 'REM' },
        { id: 'r_pertip3',   name: 'PerTip',    title: 'Tipo persona: 1=Persona (PK)',                                          type: 'n',      length:  5, dec: 0, prefix: 'REM' },
        { id: 'r_percod3',   name: 'PerCod',    title: 'Parte numérica del RUT (PK)',                                           type: 'n',      length: 12, dec: 0, prefix: 'REM' },
        { id: 'r_persec3',   name: 'PerSec',    title: 'Secuencia de contrato (PK)',                                            type: 'n',      length:  5, dec: 0, prefix: 'REM' },
        { id: 'r_tmpcod',    name: 'TmpCod',    title: 'Código tipo de movimiento de personal (PK)',                            type: 'n',      length:  5, dec: 0, prefix: 'REM' },
        { id: 'r_mpesec',    name: 'MpeSec',    title: 'Secuencia del movimiento (PK)',                                         type: 'n',      length:  5, dec: 0, prefix: 'REM' },
        { id: 'r_mpefchini', name: 'MpeFchIni', title: 'Fecha de inicio del movimiento',                                       type: 'd',      length:  8, dec: 0, prefix: 'REM' },
        { id: 'r_mpefchfin', name: 'MpeFchFin', title: 'Fecha de término del movimiento',                                      type: 'd',      length:  8, dec: 0, prefix: 'REM' },
        { id: 'r_mpediatot', name: 'MpeDiaTot', title: 'Días totales del movimiento',                                          type: 'n',      length: 10, dec: 4, prefix: 'REM' },
        { id: 'r_mpediadc',  name: 'MpeDiaDsc', title: 'Días a descontar del sueldo',                                          type: 'n',      length: 10, dec: 4, prefix: 'REM' },
        { id: 'r_mpediaahb', name: 'MpeDiaHab', title: 'Días hábiles del movimiento',                                          type: 'n',      length: 10, dec: 4, prefix: 'REM' },
        { id: 'r_mpehabtrb', name: 'MpeHabTrb', title: 'Días hábiles trabajados',                                              type: 'n',      length: 10, dec: 4, prefix: 'REM' },
        { id: 'r_mpehrs',    name: 'MpeHrs',    title: 'Horas del movimiento',                                                  type: 'n',      length:  5, dec: 0, prefix: 'REM' },
        { id: 'r_mpeobs',    name: 'MpeObs',    title: 'Observaciones del movimiento',                                         type: 'string', length: 50, dec: 0, prefix: 'REM' },
        { id: 'r_mpecodlic', name: 'MpeCodLic', title: 'Código de licencia médica',                                            type: 'n',      length:  5, dec: 0, prefix: 'REM' },
        { id: 'r_mpelfmval', name: 'MpeLfmVal', title: 'Valor licencia fuera del mes',                                         type: 'n',      length: 19, dec: 4, prefix: 'REM' },
        { id: 'r_mpelfmdia', name: 'MpeLfmDia', title: 'Días licencia fuera del mes',                                          type: 'n',      length: 10, dec: 4, prefix: 'REM' },
        { id: 'r_mpevacaut', name: 'MpeVacAut', title: 'Movimiento de vacaciones creado automáticamente',                      type: 'n',      length:  5, dec: 0, prefix: 'REM' },
      ],
    },
    {
      name: 'CONCEPTO',
      description: 'Maestro de conceptos de remuneraciones — define cada haber o descuento con sus atributos tributarios y previsionales. JOIN con MovFic2 por CptTip+CptCod.',
      attributes: [
        { id: 'r_cpttip2',   name: 'CptTip',    title: 'Tipo del concepto (PK)',                                                type: 'string', length:  1, dec: 0, prefix: 'REM' },
        { id: 'r_cptcod2',   name: 'CptCod',    title: 'Código del concepto (PK)',                                              type: 'string', length:  3, dec: 0, prefix: 'REM' },
        { id: 'r_cptnom',    name: 'CptNom',    title: 'Nombre del concepto — aparece en la liquidación',                      type: 'string', length: 22, dec: 0, prefix: 'REM' },
        { id: 'r_cptatrimp', name: 'CptAtrImp', title: 'Concepto imponible (afecto a cotizaciones previsionales): 1=Sí, 0=No', type: 'n',      length:  5, dec: 0, prefix: 'REM' },
        { id: 'r_cptatrtri', name: 'CptAtrTri', title: 'Concepto tributable (afecto a impuesto único): 1=Sí, 0=No',            type: 'n',      length:  5, dec: 0, prefix: 'REM' },
        { id: 'r_cptatrcos', name: 'CptAtrCos', title: 'Concepto es costo de la empresa: 1=Sí, 0=No',                         type: 'n',      length:  5, dec: 0, prefix: 'REM' },
        { id: 'r_cptatremb', name: 'CptAtrEmb', title: 'Concepto embargable: 1=Sí, 0=No',                                     type: 'n',      length:  5, dec: 0, prefix: 'REM' },
        { id: 'r_cptatrred', name: 'CptAtrRed', title: 'Concepto reducible a días trabajados: 1=Sí, 0=No',                    type: 'n',      length:  5, dec: 0, prefix: 'REM' },
        { id: 'r_cptatrper', name: 'CptAtrPer', title: 'Concepto permanente (persiste al siguiente mes): 1=Sí, 0=No',         type: 'n',      length:  5, dec: 0, prefix: 'REM' },
        { id: 'r_cptatrsob', name: 'CptAtrSob', title: 'Concepto de sobre tiempo (horas extra): 1=Sí, 0=No',                  type: 'n',      length:  5, dec: 0, prefix: 'REM' },
        { id: 'r_cptatrant', name: 'CptAtrAnt', title: 'Concepto para anticipos de sueldo: 1=Sí, 0=No',                       type: 'n',      length:  5, dec: 0, prefix: 'REM' },
        { id: 'r_cptfchini', name: 'CptFchIni', title: 'Fecha inicio vigencia del concepto',                                   type: 'd',      length:  8, dec: 0, prefix: 'REM' },
        { id: 'r_cptfchfin', name: 'CptFchFin', title: 'Fecha término vigencia del concepto',                                  type: 'd',      length:  8, dec: 0, prefix: 'REM' },
        { id: 'r_cptdettip', name: 'CptDetTip', title: 'Tipo de concepto: 1=Fórmula, 2=Informado, 3=Predefinido, 4=Traspaso', type: 'n',      length:  5, dec: 0, prefix: 'REM' },
        { id: 'r_cptper',    name: 'CptPer',    title: 'Permanente al cierre de mes (se traspasa al mes siguiente): 1=Sí',    type: 'n',      length:  5, dec: 0, prefix: 'REM' },
        { id: 'r_cptforcen', name: 'CptForCen', title: 'Requiere centro de costo en el ingreso: 1=Sí, 0=No',                  type: 'n',      length:  5, dec: 0, prefix: 'REM' },
        { id: 'r_cptcanreq', name: 'CptCanReq', title: 'Requiere cantidad al ingresar movimiento: 1=Sí, 0=No',                type: 'n',      length:  5, dec: 0, prefix: 'REM' },
        { id: 'r_cptcanglo', name: 'CptCanGlo', title: 'Glosa que acompaña al concepto en la liquidación',                    type: 'string', length: 25, dec: 0, prefix: 'REM' },
        { id: 'r_cptplacod', name: 'PlaCod',    title: 'Cuenta contable asociada al concepto',                                 type: 'string', length:  9, dec: 0, prefix: 'REM' },
        { id: 'r_cptisadsc', name: 'CptIsaDsc', title: 'Es descuento de Isapre: 1=Sí, 0=No',                                 type: 'n',      length:  5, dec: 0, prefix: 'REM' },
        { id: 'r_cptccadsc', name: 'CptCcaDsc', title: 'Es descuento de Caja de Compensación: 1=Sí, 0=No',                   type: 'n',      length:  5, dec: 0, prefix: 'REM' },
        { id: 'r_cptprovac', name: 'CptProVac', title: 'Participa en provisión de vacaciones: 1=Sí, 0=No',                   type: 'n',      length:  5, dec: 0, prefix: 'REM' },
        { id: 'r_cptfin',    name: 'CptFin',    title: 'Solo participa en cálculo de finiquitos: 1=Sí, 0=No',                type: 'n',      length:  5, dec: 0, prefix: 'REM' },
        { id: 'r_cptdscleg', name: 'CptDscLeg', title: 'Es descuento legal (AFP, salud, etc.): 1=Sí, 0=No',                  type: 'n',      length:  5, dec: 0, prefix: 'REM' },
        { id: 'r_cptdepcon', name: 'CptDepCon', title: 'Es depósito convenido APV: 1=Sí, 0=No',                              type: 'n',      length:  5, dec: 0, prefix: 'REM' },
        { id: 'r_cptpacto',  name: 'CptPacto',  title: 'Es pacto de reducción o suspensión laboral: 1=Sí, 0=No',             type: 'n',      length:  5, dec: 0, prefix: 'REM' },
        { id: 'r_cptcalant', name: 'CptCalAnt', title: 'Participa en cálculo de anticipos: 1=Sí, 0=No',                      type: 'n',      length:  5, dec: 0, prefix: 'REM' },
        { id: 'r_cptatrasc', name: 'CptAtrASC', title: 'Participa en semana corrida vendedores: 1=Sí, 0=No',                 type: 'n',      length:  5, dec: 0, prefix: 'REM' },
      ],
    },
  ],
};
