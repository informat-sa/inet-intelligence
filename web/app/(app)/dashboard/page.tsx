  ...
  return (
    <div className="flex h-screen-mobile bg-surface dark:bg-slate-950 overflow-hidden">
      ...
      <div className="flex flex-col flex-1 min-w-0 min-h-0">
        {/* ── Header ─────────────────────────────────────────────────────── */}
        <header className="flex items-center justify-between px-4 md:px-6 py-0 h-14
          ...
          <div className="flex items-center gap-3 min-w-0">
            ...
            {/* Logo mobile */}
            {!activeConversationId && (
              <div className="md:hidden w-6 h-6 rounded-lg flex items-center justify-center
                              flex-shrink-0" style={{ backgroundColor: "#0F1E35" }}>
            ...
            <div className="min-w-0">
              <h1 className="text-[13px] font-semibold text-slate-800 dark:text-white
                             truncate leading-tight tracking-tight">
                {activeConversationId
                  ? (useChatStore.getState().conversations.find(c => c.id === activeConversationId)?.title
                     ?? "Nueva consulta")
                  : "I-NET Intelligence"}
              </h1>
              <p className="text-[10px] text-slate-400 dark:text-slate-500 hidden sm:block
                            font-medium leading-tight mt-0.5 capitalize">
          ...
          {/* Derecha: módulo activo + empresa + estado ERP */}
            ...
            <AnimatePresence>
              {activeMod && ActiveModIcon && (
                <motion.div
                  ...
                  style={{
                    backgroundColor: `${activeMod.color}10`,
                    borderColor:     `${activeMod.color}25`,
