...
import {
  Sparkles, ArrowLeft, Lock, Eye, EyeOff,
...
function ResetPasswordForm() {
  ...
  type Stage = "validating" | "invalid" | "form" | "loading" | "success" | "error";
            ...
            {stage === "invalid" && (
              <motion.div key="invalid"
                ...
                <p className="text-slate-400 text-sm leading-relaxed mb-6">
                  ...
                  Los enlaces de recuperación duran <strong className="text-slate-300">1 hora</strong>.
                </p>
                    ...
                    <div className="relative flex">
                      ...
                      <button type="button" onClick={() => setShowPw(!showPw)}
                        className="bg-slate-800 border border-l-0 border-slate-600 rounded-xl
                                   rounded-l-none px-3 text-slate-500 hover:text-slate-300
                                   transition-colors">
